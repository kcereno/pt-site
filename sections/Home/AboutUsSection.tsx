          ...
          <div className="flex flex-col md:flex-row md:gap-5 md:mt-10 ">
            ...
            <div className="flex-1 my-auto">
              <p className="py-2 text-lg">
                ...
                limited to, your work and home stressors, overall body
                condition, nutrition, genetic & postural habits, emotional
                connections and patterns that are held in your muscles
              </p>
            </div>
          </div>
        </div>{' '}
